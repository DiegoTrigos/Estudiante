...
public class Estudiante
{
    ...
    String email,String direccion,Integer edad,String documento,String tipodoc,
    Integer creditos,Integer semestre,String estado,Carrera carrera){
        this.codigo=codigo;
        this.nombre=nombre;
 ...
 * matricular proyecto de grado, el estudiante debe haber aprobado el 70% de los creditos y estar en 7 semestre o estar en un sementre superior
 * obtener el promedio de creditos por semetre
 * mostrar si el estudiante curso el total de creditos de la carrera
 * el estudiante puede tener estado: Matriculado, PFU
 * actualizar el estado (El estudiante)
 */
